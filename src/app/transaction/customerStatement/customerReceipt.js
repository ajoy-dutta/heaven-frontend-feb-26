...
export const handleDownloadPDF = (sales, filters, totalSales, totalPaid, totalDue, toast) => {
  ...
  doc.text("77 R.N. Road, Noldanga Road (Building), Jashore-7400", pageWidth / 2, 68, { align: "center" });
  doc.text("Phone: 0421-66095, Mob: 01924-331354 | Email: support@firozautos.com", pageWidth / 2, 81, { align: "center" });
